...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "INC" -parent ${Page_0}
...
proc update_PARAM_VALUE.INC { PARAM_VALUE.INC } {
	# Procedure called to update INC when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.INC { PARAM_VALUE.INC } {
	# Procedure called to validate INC
	return true
}
...
proc update_MODELPARAM_VALUE.INC { MODELPARAM_VALUE.INC PARAM_VALUE.INC } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.INC}] ${MODELPARAM_VALUE.INC}
}
