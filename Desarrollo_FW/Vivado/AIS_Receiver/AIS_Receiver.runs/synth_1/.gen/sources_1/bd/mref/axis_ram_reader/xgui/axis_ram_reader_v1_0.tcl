...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "MAX_OUTSTANDING" -parent ${Page_0}
...
proc update_PARAM_VALUE.MAX_OUTSTANDING { PARAM_VALUE.MAX_OUTSTANDING } {
	# Procedure called to update MAX_OUTSTANDING when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.MAX_OUTSTANDING { PARAM_VALUE.MAX_OUTSTANDING } {
	# Procedure called to validate MAX_OUTSTANDING
	return true
}
...
proc update_MODELPARAM_VALUE.MAX_OUTSTANDING { MODELPARAM_VALUE.MAX_OUTSTANDING PARAM_VALUE.MAX_OUTSTANDING } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.MAX_OUTSTANDING}] ${MODELPARAM_VALUE.MAX_OUTSTANDING}
}
