...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "CONST_VALUE" -parent ${Page_0}
  ipgui::add_param $IPINST -name "CONST_WIDTH" -parent ${Page_0}


}

proc update_PARAM_VALUE.CONST_VALUE { PARAM_VALUE.CONST_VALUE } {
	# Procedure called to update CONST_VALUE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.CONST_VALUE { PARAM_VALUE.CONST_VALUE } {
	# Procedure called to validate CONST_VALUE
	return true
}
...
proc update_MODELPARAM_VALUE.CONST_VALUE { MODELPARAM_VALUE.CONST_VALUE PARAM_VALUE.CONST_VALUE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.CONST_VALUE}] ${MODELPARAM_VALUE.CONST_VALUE}
}
